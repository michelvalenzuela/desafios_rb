...
if (eleccion_del_usuario == 'piedra' and pc == 'piedra') \
  or (eleccion_del_usuario == 'papel' and pc == 'papel') \
  or (eleccion_del_usuario == 'tijera' and pc == 'tijera')
  puts "EMPATE"
elsif (eleccion_del_usuario == 'piedra' and pc == 'tijera') \
  or (eleccion_del_usuario == 'papel' and pc == 'piedra') \
  or (eleccion_del_usuario == 'tijera' and pc == 'papel')
  puts "!!!!!!!!! GANASTE !!!!!!!!!!!!!"
elsif (eleccion_del_usuario == 'piedra' and pc == 'papel') \
  or (eleccion_del_usuario == 'papel' and pc == 'tijera') \
  or (eleccion_del_usuario == 'tijera' and pc == 'piedra')
  puts ":( perdiste"
end
